...
def integrations_html():
    ...
    if ts:
        try:
            ...
            if age_min > 15:
                checked += " &middot; <b>stale (%dm ago)</b>" % age_min
            else:
                checked += " &middot; %dm ago" % age_min
        except Exception:
            pass
...
<div class="card"><h2>Integrations</h2>__INTEGRATIONS__</div>
__CARD__
<div class="card"><h2>Task queue</h2>__TASKS__</div>
<h2 style="margin:6px 2px 10px">Activity</h2>
__ROWS__
